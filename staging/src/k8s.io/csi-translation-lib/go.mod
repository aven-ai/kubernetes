...
replace github.com/cilium/ebpf => github.com/cilium/ebpf v0.0.0-20191025125908-95b36a581eed
...
replace golang.org/x/net => golang.org/x/net v0.0.0-20201022231255-08b38378de70
...
replace k8s.io/gengo => k8s.io/gengo v0.0.0-20200114144118-36b2048a9120
